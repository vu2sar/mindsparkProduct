<?php
	...
	$set_soln_date = date('Y-m-d', strtotime($dateToday .' -4 day'));
...
<title>Explore Zone</title>
	...
	<?php if($theme==3) { ?>
		...
		if(mmd >= mmd1)
		{
					alert("Set a date before this Monday");
		}
		else
		{
...
<body  class="translation" onLoad="load()" onResize="load()">
	...
	<?php if($TeaserDescription[0]!= "teaseDate"){ ?>
	<div id="teaser_head"> Monday's Brain Teaser </div>
	<?php } 
	else{ ?>
	...
	<input id="ok_button"  type="button" value="Ok" onClick="loadPreviousTeaser()"/>
	<script>
	...
	<div id=teaser_notification> Come back on next Thursday for the answer to this teaser </div>
	...
	<?php if ($sResponse[0]!="")
	{ ?>
	<div id=teaser_notification>You have already answered. Come back on next Thursday for the answer to this teaser </div>
	<?php } ?>
