<?php
	...
	//echo "SID ".$_SESSION['sessionID'];exit;
...
<?php
	...
	{
		$query  = "INSERT INTO adepts_feedbackresponse (userID, qid, response, feedbackset, feedbackdate, category) VALUES ($userID, $key, \"".mysql_real_escape_string($value)."\", $feedbackset, now(),'STUDENT')";
