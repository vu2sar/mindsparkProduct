...
{ // hide the namespace
    ...
    $.extend(Keypad.prototype, {
        ...
        _generateHTML: function (inst)
        {
			...
			filter('.' + this._keyClass).on('touchend mouseup',function (event) { if(event.type=='mouseup' && buttonState=='clicked') {buttonState = 'latent'; return;} plugin._selectValue(thisInst, $(this).text()); if(event.type=='touchend') buttonState = 'clicked'; });
            ...
            $.each(this._specialKeys, function (i, keyDef)
            {
                ...
                html.find('.' + plugin._namePrefixClass + keyDef.name).on('touchend',function ()
                {
