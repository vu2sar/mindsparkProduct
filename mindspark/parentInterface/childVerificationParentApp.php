...
//        $secondayrParentEmailArray = explode(',', $secondaryParentEmail);
        ...
        if (!$registrationError) {
            ...
            if ($resultRegistration === false) {
                $msg .= "There was an error while mapping this child. Please try again. If issue persists please write to <a style='color:yellow' href='mailto:mindspark@ei-india.com'>mindspark@ei-india.com</a> with following details:";
                $msg .= "<ol><li>";
                ...
                if (!$innerStudentMapPage)
                    ...
                    <br><br>    <input type="button" class="loginButton btn btn-success" id="option2" name="option2" value="Go to the Parent Connect" onclick="javascript:optionRedirect(2);"/>&nbsp;
                                <input type="button" class="loginButton btn btn-success" id="option3" name="option3" value="Login to '.$userName.'\'s account " onclick="javascript:optionRedirect(3);"/>&nbsp;';
...
<div class="row">
                  <div class="col-lg-6" >
                      <section class="panel">
                          ...
                          <div class="panel-body divVerification" <?php echo ($innerStudentMapPage ? 'style="font-size: 1.3em;"' : ''); ?>>

                            <div>
                                <span style="<?php echo ($disableRegister ? 'display:none;' : 'display: block;'); ?>"> Please share the following information to map your child with your Username.</span>
                                <span style='color:<?= ($registrationError ? 'yellow' : '#78CD51') ?>; padding-top:7px; display: <?= $msg != '' ? 'block' : 'none' ?>'><?= $msg ?></span>
                            </div>
                              ...
                              <form Method="POST" name='formVerification' id="formVerification" style="padding: 5px; <?php echo ($disableRegister ? 'display:none;' : ''); ?> ">
                                ...
                                <script>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="Box form-control" name="studentName" maxlength="100" id="studentName" value="<?= $studentName ?>" size='30'></input>
                                  </div>

                                  <div class="form-group">  
                                      <label for="InputUserName">Mindspark Username*</label>
                                      <input type="text" class="Box form-control" name="userName" maxlength="50" id="userName" value="<?= $userName ?>" size='30'></input>

                                  </div>
                                
                                  <div class="form-group">  
                                      <label for="InputSchoolName">School Name</label>
                                      <input type="text" class="Box form-control" name="schoolName" maxlength="100" id="schoolName" value="<?= $schoolName ?>" size='30'></input>
                                    ...
                                    <div class="form-group">  
                                      ...
                                      <input type="text" class="Box form-control" name="city" maxlength="50" id="city" value="<?= $city ?>" size='30'></input>
                                    </div>

                                    <div class="form-group">  
                                      <label for="InputDateOfBirth">Student's Date of Birth(As registered with Mindspark)*</label>
                                    ...
                                    <div class="form-group">
                                    <input type="button" class="loginButton btn btn-success" id="verify" name="verify" value="Verify" onclick='javscript:validate();' />  
                                    <input type="button" class="loginButton btn btn-warning" id="verifyCancel" name="verifyCancel" value="Back" onClick="javascript:redirect('childRegistrationOuter.php')"/>
