...
//            var_dump($userDetail);
            ...
            $msg = "We have signed up your child for 7 day free trial.  Mindspark login credentials of $childName have been emailed to you. Please check the email.  ";
            
            if (!$innerStudentMapPage)
            {   $hideFormVerification=1;
                $msg.='Click on one of the options below to proceed further: 
                    <br><br>    <input type="button" class="greenButton" id="option2" name="option2" value="Go to the Parent Connect" onclick="javascript:optionRedirect(2);"/>&nbsp;
                                <input type="button" class="greenButton" id="option3" name="option3" value="Login to '.$childName.'\'s account " onclick="javascript:optionRedirect(3);"/>&nbsp;';
            }
            $redirect = TRUE;
...
<?php } ?>
    ...
    function optionRedirect(i) {
        ...
        switch(i){
            ...
            case 2: 
            setTryingToUnload();
            window.location = '../app/parent/ui/#/parents/home/homeContent';
            break;
...
<body  style="height: 100%; vertical-align: central" height="70%" width="70%">
    ...
    <div class="divVerification" <?php echo ($innerStudentMapPage ? 'style="font-size: 1.3em;"' : ''); ?>>
        <div>
            <?php if (!$innerStudentMapPage) { ?> <h3 style="display: block">Register your child</h3> <?php } ?>
        ...
        <div style='padding-top: 15px; display: block;'>
            <form Method="POST" name='formVerification' id="formVerification" style="padding: 5px; <?php echo ($disableRegister ? 'display:none;' : ''); ?>">
                ...
                <table  width="<?php echo ($innerStudentMapPage ? '70%' : '60%'); ?>" border="0" align="left" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10pt;">
                    <tr>
                        <td>Child First Name*:</td>
                        <td><input id="firstName" name="firstName" type="text" size="30" maxlength="100" value="<?php echo $firstName; ?>" onKeyPress="return textonly(event);"></td>
                    </tr>
                    <tr>
                        <td>Child Last Name*:</td>
                        <td><input id="lastName" name="lastName" type="text" size="30" maxlength="100" value="<?php echo $lastName; ?>" onKeyPress="return textonly(event);"></td>
                    </tr>
<!--                    <tr>
                        <td>
                            Relation:
                        ...
                        <td>
                            <select name="relation" id="relation" style="width:100px;" class="textBoxes" onchange="showHideOtherRelation(this.value);">
                            ...
                            <div style="display:none" id="pnlRelationOther">
                                &nbsp;&nbsp;Please Specify: <input type="text" id="txtRelation" style="width:100px;" name="txtRelation">
                            </div>
                        </td>
                    </tr>-->
                    <tr>
                        <td>Class*:</td>
                        <td><select name="childClass" id="selGrade">
                                <option value="">Select</option>
                                <?php
                                for ($i = 1; $i <= 10; $i++) {
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="board" id="board" style="width:100px;" id="board" class="textBoxes" onchange="showHideOther(this.value);">
                                <option value="">Select</option>
                            ...
                            <div style="display:none" id="pnlBoardOther">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="homeSchool" id="homeSchool" id="homeSchool" class="textBoxes" onchange="showHideSchoolName(this.value);">
                                <option value="">Select</option>
                    ...
                    <tr id="trSchoolName">
                        <td>School Name*:</td>
                        <td><input id="schoolName" name="schoolName" type="text" size="30" maxlength="100" value="<?php echo $schoolName; ?>"></td>
                    </tr>
                    <tr>
                        <td>City:</td>
                        <td><input id="city" name="city" type="text" size="30" maxlength="100" value="<?php echo $city; ?>"></td>
                    </tr>
                    <tr>
                        <td>Date of Birth*:</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="gender" style="width:190px;" id="gender" class="textBoxes">
                                <option value="">Select</option>
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="textBoxes usingPlaceHolder" type="text" name="username" id="txtUsername"  style="width:180px;" size="40" maxlength="100" onBlur="ajaxValidation(this.value, true);" value="<?php echo $username; ?>" onKeyPress="return blockSpecialChar(event);"/>
                    ...
                    <tr>
                        <td>Password:*</td>
                        <td><input id="password" name="password" type="password" style="width:180px;" size="40" maxlength="40" value="<?php echo $password; ?>"></td>
                    </tr>
                    <tr>
                        <td>Confirm Password:*</td>
                        <td><input id="confirmPassword" name="confirmPassword" type="password" style="width:180px;" size="40" maxlength="40" value="<?php echo $password; ?>"></td>
                    </tr>
                    <tr>
                        <td>My class changes in*:</td>
                        <td>
                            <!--<input type="text" name="dateUpgradation" class="datepicker floatLeft" id="dateUpgradation" value="<?php echo $classUpgradationDateDisp; ?>" autocomplete="off" onkeydown="return DateFormat(this, event.keyCode)" maxlength="10" size="15"/><div class="calenderImage linkPointer" id="from" onClick="openCalender(id)"></div>-->
                            <input type="text" id="dateUpgradation" name="dateUpgradation" value="<?php echo $classUpgradationDateDisp; ?>" style="width:180px;">&nbsp;<a href="#" onClick="return showClassChangeAlert();" tabindex="-1"><img src="assets/WhatsThis.png" id="imgWhatsThis"></a>
                        </td>
                    </tr>                    
                    <tr>
                        <td colspan="2">
                            <input type="button" class="loginButton greenButton <?php echo ($disableRegister ? 'buttonDisabled' : ''); ?>" id="Register" name="Register" value="Register" onclick='javscript:validate();' <?php echo ($disableRegister ? 'disabled' : ''); ?>/>
                        </td>
                    </tr>
                    <?php if (!$innerStudentMapPage && !isset($_SESSION["data_set_parent"])) {
                        ?>
                        <tr>
                            <td colspan="2">
                                <br/>
                        ...
                        <tr>
                            <td colspan="2">
                                <a href="childVerificationOuter.php" class="linkClass">Is your child already using Mindspark?</a>
                            </td>
                        </tr>
                    <?php } ?>
                </table>                
