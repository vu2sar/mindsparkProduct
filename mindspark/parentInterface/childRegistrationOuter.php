...
$innerStudentMapPage = FALSE;
        ...
        if($parentApp)
        {
            $parentAppStyles= '<title>Register your child</title>';
            $parentAppStyles.= '<meta http-equiv="Content-Type" content="text/html;" charset="UTF-8"/>';
            $parentAppStyles.= '<meta http-equiv="X-UA-Compatible" content="IE=9">';
            $parentAppStyles.= '<meta name="viewport" content="user-scalable=no, initial-scale=1, maximum-scale=1, minimum-scale=1, width=device-width, height=device-height, target-densitydpi=device-dpi" />';
            $parentAppStyles.= '<head>
                                <meta charset="utf-8">
            ...
            $parentAppStyles.= '<link rel="shortcut icon" href="img/favicon.png"><title>Mindspark - Parent Interface</title>';
            //<!-- Bootstrap core CSS -->
            $parentAppStyles.= '<link href="../parentApp/css/bootstrap.min.css" rel="stylesheet">';
            $parentAppStyles.= '<link href="../parentApp/css/bootstrap-reset.css" rel="stylesheet">';
            //<!--external css-->
            $parentAppStyles.= '<link href="../parentApp/assets/font-awesome/css/font-awesome.css" rel="stylesheet" />';
            //<!-- Custom styles for this template -->
            $parentAppStyles.= '<link href="../parentApp/css/style.css" rel="stylesheet">';
            $parentAppStyles.= '<link href="../parentApp/css/style-responsive.css" rel="stylesheet" />';
            $parentAppStyles.= '<link href="../parentApp/css/custom.css" rel="stylesheet" type="text/css" />';
            $parentAppStyles.= '<script src="libs/jquery-1.9.1.min.js"></script>
        ...
        {
           $parentInterfaceStyles= '<title>Register your child</title>';
           $parentInterfaceStyles.= '<meta http-equiv="Content-Type" content="text/html;" charset="UTF-8"/>';
           $parentInterfaceStyles.= '<meta http-equiv="X-UA-Compatible" content="IE=9">';
           $parentInterfaceStyles.= '<meta name="viewport" content="user-scalable=no, initial-scale=1, maximum-scale=1, minimum-scale=1, width=device-width, height=device-height, target-densitydpi=device-dpi" />
...
<?php 
    ...
    {
        echo '<div class="logo1"></div><body class="translation" style="height: 100%; vertical-align: central" height="100%">'; 
...
?>
    ...
    if($parentApp)
    { 
        include('childRegistrationParentApp.php'); include('../parentApp/footer.php'); echo '</section>';
    }
    else 
    { 
