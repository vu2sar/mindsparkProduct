...
Helpers = {
    constants : {
        ...
        GET_PASSAGE_PATH : '/techmCodeCommit/mindsparkProduct/mindspark/mslanguage/ProofTypePassageBranch/src/saverLoader.php',
        ...
        TOAST_ID : 'toast',
        IDLE_TIME : 60,
         MSLANGUAGE_PATH : '/techmCodeCommit/mindsparkProduct/mindspark/mslanguage/',
    ...
    disableHistoryNavigation: function() {
        ...
        history.pushState(null, null, '/techmCodeCommit/mindsparkProduct/mindspark/ms_english/Language/session');
...
window.onhashchange = function(){
    if(window.location.pathname == '/techmCodeCommit/mindsparkProduct/mindspark/login/' || window.location.pathname == '/techmCodeCommit/mindsparkProduct/mindspark/login/index.php')
    {
        setTryingToUnload();
