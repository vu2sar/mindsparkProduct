...
class User_model extends CI_model
{
	...
	public function checkUserLevel() {
		...
		$result=($passageLevel==$freeQuesLevel)? (($passageLevel==$conversationLevel)?(($passageLevel==$childClass)?0:1) :1):1;
		return $result;
	}
	...
	public function updateUserCurrentStatusLevel($user_id)
	{
		...
		$this->session->set_userdata('conversationLevel',$conversationLevel);
		$this->session->set_userdata('passageLevel', $passageLevel);
		$this->session->set_userdata('freeQuesLevel', $freeQuesLevel);
