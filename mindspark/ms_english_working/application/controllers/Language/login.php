...
Class Login extends CI_Controller
{
	...
	function startSession()
	{
		...
		$checkUserLevel = $this->user_model->checkUserLevel();
		if($checkUserLevel==1) :
		...
		$this->session->set_userdata('preview',"off");
	          ...
	          $getSchoolContentFlowOrder = $this->user_model->getSchoolContentFlowOrder($this->session->userdata('schoolCode'),$childClass);
	          ...
	          $getCosntantvalue = $this->studentsessionflow_model->getConstantValue($this->session->userdata('remediationTemplateID'));
