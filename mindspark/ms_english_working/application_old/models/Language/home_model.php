...
Class Home_model extends MY_Model
{
	...
	function setTeacherPendingEssayCount($userID)
	{
		...
		$getEssayDetail=$this->dbEnglish->query("SELECT count(*) as totalEssayPendingCnt from essayScoring a , essayDetails b ,essayMaster c where a.essayID=b.essayID and b.topicID=c.topicID and a.evaluatorID=$userID and a.status=0");
	 ...
	 * */
        function getAssignedEssayCount(){
            ...
            $this->dbEnglish->Select('teacherEssayActivation.topicID , essayMaster.essayTitle');
            ...
            if(isset($queryResult[0]) && !empty($queryResult)){
                ...
                $this->dbEnglish->where('topicID',$queryResult[0]['topicID']);
                $this->dbEnglish->where('userID',$userID);
