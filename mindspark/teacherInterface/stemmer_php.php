...
class Stemmer
{
    ...
    function stem( $word )
    {
		...
		$result = $this->handleDeviations($word);
		if($result==1)
		return $word;
	...
	/**
	* This function is use for handling deviations for which the stmemer does not behave ideally
	*/
	
	function handleDeviations($word)
	{
		if(substr($word,0,5)=='integ')
		return 1;
		else
		return 0;
	}
