	...
	*/
...

	{
		...
		echo "<table cellpadding='0' cellspacing='0' width='100%' border='0'><tr>".
				...
				"<tr><td width='35%' class='leftcoltext' valign='bottom' align='left'><b>Showing records ".$this->recsfrom."-".$this->recsto." (".$this->numofrecs." Total)</b></td><td align='right' valign='bottom' class='pagingNos'> ";

		if ($rangecurrent==1)

			echo "<img border='0' src='".$URL_IMG."images/prev.gif' width='12px' height='12px'>";
...

		{
			...
			if ($javascript) $turl="javascript:navigatepage('$varprefix',1);";
				...
				echo "<b><span class='goldentext'>";

				echo "<A href=\"$turl\">1</b></span></A>";
				
				echo "&nbsp;<sup><span onclick='firstPage()' style='color:blue;'><font size='1'>?</font></span></sup>&nbsp;";
			...
			if ($javascript) $turl="javascript:navigatepage('$varprefix',$rangeprevpg);";
				...
				echo "<img src='".$URL_IMG."images/prev.gif' border=0  width='12px' height='12px'></A>";

		}

		echo "<span class='goldentext'>";
		...
		if ($rangecurrent==$rangetotal)
			...
			echo "&nbsp;&nbsp;<img border='0' src='".$URL_IMG."images/next.gif' width='12px' height='12px'>";
...

		{
			...
			if ($javascript) $turl="javascript:navigatepage('$varprefix',$rangenextpg);";
				...
				echo "&nbsp;&nbsp;<img src='".$URL_IMG."images/next.gif' border=0  width='12px' height='12px'></A>";

			$turl="$url&$varprefix"."_cp=$this->numofpages";

			if ($javascript) $turl="javascript:navigatepage('$varprefix',$this->numofpages);";

				echo "&nbsp;&nbsp;&nbsp;<b><span class='goldentext'><A href=\"$turl\">$this->numofpages</b></span></A>";
				echo "&nbsp;<sup><span onclick='lastPage()' style='color:blue;'><font size='1'>?</font></span></sup>";
