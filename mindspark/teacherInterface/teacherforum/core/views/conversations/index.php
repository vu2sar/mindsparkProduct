...
<input name='search' type='text' class='text' data-intro='<?php echo T("SearchHelp") ?>' value='<?php echo sanitizeHTML($data["searchString"]); ?>' spellcheck='false' placeholder='<?php echo T("Search conversations..."); ?>'/>
<a class='control-reset' href='<?php echo URL("conversations/".$data["channelSlug"]); ?>'><i class='icon-remove'></i></a>
</fieldset>
</form>

<ul id='channels' class='channels tabs' data-intro='<?php echo T("ChannelsHelp") ?>'>
...
<div id='conversations' data-intro='<?php echo T("ConversationsHelp") ?>'>
