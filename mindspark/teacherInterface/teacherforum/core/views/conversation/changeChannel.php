...
<h3><?php echo $conversation["conversationId"] ? T("Change Channel").": <em>".sanitizeHTML($conversation["title"])."</em>" : T("Choose a Channel (<em>Click on General Discussion, if unsure</em>)"); ?></h3>
