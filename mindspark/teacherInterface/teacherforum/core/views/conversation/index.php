...
<form class='search' id='searchWithinConversation' data-intro='<?php echo T("searchWithinConversationHelp") ?>' action='<?php echo URL(conversationURL($conversation["conversationId"], $conversation["title"])); ?>' method='get'>
<fieldset>
...
<?php else: ?>
<a href='#reply' class='button big' id='jumpToReply'><i class='icon-plus' data-intro='<?php echo T("ReplyHelp") ?>'></i> <?php echo T("Post a Reply"); ?></a>
<?php endif; ?>
