...
{
	// Start a session.
	/*Disabling session here as we already started one in index file*/
	...
	/*Assigning username session variable if it exists (if coming from teacher interface)*/
	$this->username = $_SESSION["username"];
	/*Assigning userID variable to use in logout function to logout of teacher interface as well*/
	$this->userID = $_SESSION["userID"];
...
public function logout()
{
	...
	$this->regenerateToken();
	/*Removing username session variable so that user won't be autologged in after logout*/
	ET::$session->remove("username");
	/*Remove userID session variable to logout of teacher interface*/
	ET::$session->remove("userID");
