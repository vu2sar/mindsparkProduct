...
function trackTeacherwhatsnew(pageId)
{
	 $.ajax({
            url: "ajaxRequest.php",
            data: "pageId="+pageId+"&mode=whatsKeepingBusy",
            type: "POST",
            success: function(data){
					if(pageId == 78)
						window.location = "whatsNew.php#whatsKeepingBusy";
					else
						window.location = "whatsNew.php#pnlWhatsNew";				
            }
        });
}
</script>
...
<body class="translation" onload="load()" onresize="load()">
	...
	<table align="center" width="98%" border="0" cellpadding="3" cellspacing="3">
        ...
        <a class="links removeDecoration" style="cursor:pointer; <?php echo (($secId=='')?'':"display:none;"); ?>" onclick="trackTeacherwhatsnew(78);"  onclick="setTimeout(function() {tryingToUnloadPage = false;},500);">What's been keeping us busy</a>
        <a class="links removeDecoration" href="whatsNew.php" <?php echo (($secId=='')?"style='display:none;'":''); ?> onclick="setTimeout(function() {tryingToUnloadPage = false;},500);">Go Back</a>
        </div>
        </div>
        </td>
        </tr>
        ...
        <div class="linkToMore hidden">
        <a class="links removeDecoration" style="cursor:pointer;" onclick="trackTeacherwhatsnew(79);" <?php echo (($secId=='')?'':"style='display:none;'"); ?> onclick="setTimeout(function() {tryingToUnloadPage = false;},500);">What's new in Mindspark?</a>
        <a class="links removeDecoration" href="whatsNew.php" <?php echo (($secId=='')?"style='display:none;'":''); ?> onclick="setTimeout(function() {tryingToUnloadPage = false;},500);">Go Back</a>
        </div>
        </div>
        </td>
...
<div style="display:none">
    <div id="modelView">
        ...
        <div style="float:left; width:98%; height:520px">
