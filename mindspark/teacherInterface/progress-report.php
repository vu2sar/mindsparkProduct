...
<html data-ng-app="mindspark">
     <head>       
        ...
        <link rel="stylesheet" type="text/css" href="/mindspark/teacherInterface/css/co-teacher.css?ver=5">
        ...
        <script type="text/javascript" src="/mindspark/teacherInterface/libs/requestUrl.js"></script>
        <script type="text/javascript" src="/mindspark/teacherInterface/libs/coTeacher.js?ver=4"></script>
    </head>
<body>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6 whats-going-positive">
                            ...
                            <div class="col-md-6 whats-going-negative">
                            ...
                            <div class="student_information">
                                <div ng-repeat="(key,info) in student.students">
                                    <div class="md-list-item-text">
                                        ...
                                        <student-progress-assessment data="{{ info.accuracy }}" ng-click="openStudentTrail(key,'assessment',info.id,student.type)" ></student-progress-assessment>
                                    </div>
                                    <span class="line-break"></span>
                                </div>
                            </div>
                                    ...
                                    <div class="learning row" ng-repeat="data in learning_unit" on-finish-render="ngRepeatFinished">
                                        ...
                                        <div class="learning-list col-md-11 display-table">
                                            ...
                                            <div class="middle" style="width:10%">
                                                <canvas width="50" height="50" progress-chart="{{data.progress.value}}" dash="{{data.progress.dash}}" ></canvas>
                                                <button ng-show="data.progress.dash == 1" class='chart-tooltip'  data-toggle="tooltip" data-placement="left" title="" data-original-title="{{data.progress.tooltip}}" data-trigger="focus"></button>
                                            </div>
                        ...
                        <div class="assessment_details col-md-12">
                            <div class="class_accuracy row">
                                <div class="col-md-12">
                                    ...
                                    <div ng-if="length(class_accuracy.student_info) == 0" class="row">
                                        <div class="no-data col-md-12">
                                            <div class="col-md-4 text-center">
                            ...
                            <div class="class_discussion row">
                                <div class="col-md-12">
                                    <div class="header row">
                                        <span class="ghost"></span>
                                        ...
                                        <div class="critical row" ng-show="critical">
                                            ...
                                            <div ng-if="critical_data.length > 0">
                                                <div class="col-md-12 question_data loader-frame question-section" id="{{'questionArea' + ($index + 1)}}"  ng-repeat="question in critical_data">
                                                    <div id="{{'question_data'+($index + 1)}}">
                                                    <span class="question-no">{{ ($index + 1) }}</span>                                                
                                                        <iframe id="{{'questionFrame'+($index + 1)}}" src="{{'/mindspark/teacherInterface/topicReportController.php?mode='+ question.mode + '&quesDetails=' + question.qcodeListData }}" class="frame-element " ng-show="critical" onload="finished_assessent(this)" ></iframe>
                                                        <div class="common-wrong-answer-modal"></div>                                                
                                                    </div>
                                                </div>
                                                <br>
                                        ...
                                        <div class="recommended row" ng-show="recommended">
                                            ...
                                            <div ng-if="recommended_data.length > 0">
                                                <div class="col-md-12 question_data loader-frame question-section" id="{{'questionArea' + ($index + 1)}}"  ng-repeat="question in recommended_data" >
                                                    <div id="{{'question_data'+($index + 1)}}">
                                                        <span class="question-no">{{ ($index + 1) }}</span>
                                                        <iframe id="{{'questionFrame'+($index + 1)}}" src="{{'/mindspark/teacherInterface/topicReportController.php?mode='+ question.mode + '&quesDetails=' + question.qcodeListData }}" class="frame-element " ng-show="recommended"  onload="finished_assessent(this)"></iframe>
                                                        <div class="common-wrong-answer-modal"></div>
                                        ...
                                        <div class="performed_well row" ng-show="performed">
                                            ...
                                            <div ng-if="performed_data.length > 0">
                                                <div class="col-md-12 question_data loader-frame question-section" id="{{'questionArea' + ($index + 1)}}"  ng-repeat="question in performed_data">
                                                    <div id="{{'question_data'+($index + 1)}}">
                                                        <span class="question-no">{{ ($index + 1) }}</span>                                                     
                                                        <iframe id="{{'questionFrame'+($index + 1)}}" src="{{'/mindspark/teacherInterface/topicReportController.php?mode='+ question.mode + '&quesDetails=' + question.qcodeListData }}" class="frame-element " ng-show="performed" onload="finished_assessent(this)"></iframe>
                                                        <div class="common-wrong-answer-modal"></div>                                                
                                                    </div>
                                                </div>
                                                <br>
