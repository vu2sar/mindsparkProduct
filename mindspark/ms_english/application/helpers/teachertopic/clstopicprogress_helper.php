...
class clsTopicProgress
{
	...
	function clsTopicProgress($ttCode, $class, $flow, $subjectno=2)
	{
		...
		$this->sdlArray     = array();
		$objTT = new clsteacherTopic($ttCode, $class, $flow);
        $this->objTT = $objTT;
	...
	function getProgressOfNormal($userID, $tillDate="")
	{
		...
		if($clusterAttemptIDs!="" && $this->clusterStr!="")
		{
		    ...
		    $q = "SELECT a.clustercode, subdifficultylevel
		          FROM   ".TBL_QUES_ATTEMPT." a, adepts_questions c
