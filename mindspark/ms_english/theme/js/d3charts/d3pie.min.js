...
var helpers = {
	...
	initSegmentBorders: function(pie) {
			var data   = pie.options.data.content;
			var borders = pie.options.misc.colors.segments;
			// TODO this needs a ton of error handling

			var finalBorders = [];
			for (var i=0; i<data.length; i++) {
				if (data[i].hasOwnProperty("border")) {
					finalBorders.push(data[i].border);
				} else {
					finalBorders.push(borders[i]);
				}
			}
			return finalBorders;
		},
...
var math = {
	...
	computePieRadius: function(pie) {
		...
		pie.outerRadius = outerRadius-40;
	},
	...
	add: function(pie, section, sectionDisplayType) {
		...
		if (include.mainLabel) {
			...
			labelGroup.append("text")
				...
				.style("fill", function(d, i) { return pie.options.borders[i] });
	...
	addLabelLines: function(pie) {
		...
		lineGroup.append("path")
			...
			.attr("stroke", function(d, i) {
				return (pie.options.labels.lines.color === "segment") ? pie.options.borders[i] : pie.options.labels.lines.color;
			})
			.attr("stroke-width", 1)
			.attr("fill", "none")
...
var segments = {
	...
	create: function(pie) {
		...
		var borders = pie.options.borders;
		...
		var arc = d3.arc()
			...
			.innerRadius(pie.innerRadius+35)
		...
		g.append("path")
			...
			.attr("fill", function(d, i) {
				...
				if (pie.options.misc.gradient.enabled) {
					border = "url(#" + pie.cssPrefix + "grad" + i + ")";
				}
				return border;
			})
			.style("stroke", segmentStroke)
...
var tt = {
	...
	var _setupData = function () {
		...
		this.options.borders = helpers.initSegmentBorders(this);
